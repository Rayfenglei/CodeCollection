...
import com.example.ray.codecollections.util.ActivityUtil;
import com.example.ray.codecollections.util.NetBroadcastReceiver;

public abstract class BaseActivity1<PV, PT extends BasePresenter<PV>> extends AppCompatActivity implements NetBroadcastReceiver.NetChangeListener, IViewConstraint {
     ...
     * @warn 不能在子类中创建
     */
    protected BaseActivity1 context = null;
    /**
    ...
    protected BaseFragment1 fragment = null;

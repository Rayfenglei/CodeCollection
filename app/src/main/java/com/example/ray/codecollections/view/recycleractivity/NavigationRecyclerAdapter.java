...
public class NavigationRecyclerAdapter extends FragmentPagerAdapter {
    private List<Fragment> mList;
    private Context mContext;

    public NavigationRecyclerAdapter(FragmentManager fm, List<Fragment> mList, Context mContext) {
        super(fm);
        this.mList = mList;
